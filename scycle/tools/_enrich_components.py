...
def enrich_components(adata, thr=3, verbose=True):
    ...
    adata.uns["scycle"]["enrich_components"]["G1S"] = g1s_idx
    adata.uns["scycle"]["enrich_components"]["G1S_score"] = g1s_score
    adata.uns["scycle"]["enrich_components"]["G2M+"] = g2m_idx
    adata.uns["scycle"]["enrich_components"]["G2M+_score"] = g2m_score
    if g2mi_found:
        adata.uns["scycle"]["enrich_components"]["G2M-"] = g2mi_idx
        adata.uns["scycle"]["enrich_components"]["G2M-_score"] = g2mi_score
    adata.uns["scycle"]["enrich_components"]["Histone"] = histone_idx
    adata.uns["scycle"]["enrich_components"]["Histone_score"] = histone_score
