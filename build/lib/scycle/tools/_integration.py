...
def integration(
    ...
    Data dimensionality must have been reduced before applying the method. 
    Both source and reference must share the same cloud topology, otherwise 
    the technique is very prone to overfitting.
    ...
    adata_source.obsm["X_dimRed3d"] = pca.fit_transform(adata_source.obsm["X_dimRed"])
